...
enddefine;
	...
	/*	Refresh screen from window line vedrefreshneeded to the end of the window
		used for DUMB vdus which can't insert or delete lines
	*/
...
enddefine;
	...
	/*	On window line _______wline, starting from window column ______wcol blank
		_____num spaces. (Leave Ved buffer unchanged).
	*/
...
enddefine;
	...
	/* 	Transmit ______clen chars in string starting from _______index
		process tabs etc.
	*/
	...
	define :inline lconstant OUTSTRING(T=item, _ATTR_PTR=item);
		while _index _lt _index_lim do
			...
			unless _zero(_clen) then
				;;; dump ______clen standard printable chars
				0 -> vedscreencharmode;
...
enddefine;		/* vedscreensubstringout */
	...
	/*	Refresh part of WINDOW line _____wline, Starting from WINDOW column ____wcol,
		using ___num characters from ______string, starting from string location
		_____start. If _______flags is true, line is already blank.
		If ___num == 0 then use all of string.
	*/
