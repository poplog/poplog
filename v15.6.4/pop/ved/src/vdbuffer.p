...
enddefine;
	...
	/*	Split ______string into 2 strings, starting the second at _____col.
		If ____________stripwhite is true then remove leading tabs/spaces in the second.
	*/
...
enddefine;
	...
	/*	Shift the contents of a vedstring from subscript _____col down or up
		by _______ncols, expanding if necessary
	*/
define Shift_string(_col, _ncols, string, expand) -> newstring;
	...
	if _ncols fi_>= 0 then
		...
		if expand and (string == vedspacestring or _needed fi_> _len) then
			;;; need new string -- add ______expand or 20 extra
