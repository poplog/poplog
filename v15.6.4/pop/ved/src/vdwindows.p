...
enddefine;
	...
	;;; to tidy in vedsetonscreen, and which file to use for vedputmessages
	;;; during vedreadfile.
...
enddefine;
	...
	/*	Put ____file on the screen.
		_______initarg gets passed to Set_window_rest and controls the first message
		displayed.
	*/
...
define vedfileselect();
	 ...
	 * appropriate for the character _n given ______nfiles files.
...
enddefine;
	...
	/*	____file is a string or Ved file structure.
...
--- John Gibson, Aug 22 1995
		...
		existing window be '____warp and wvedalwaysraise' instead of just
...
--- John Gibson, Jun 12 1993
		Rewrote vedusewindows to call procedure wved_change_usewindows_X for
