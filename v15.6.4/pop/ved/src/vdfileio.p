...
enddefine;		/* TRANS_IN */
	...
	/*	Move _____len bytes read into ___buf across to new ______string, converting tabs,
...
enddefine;
	...
	/*	May take an optional boolean 3rd arg to say whether file is being
		...
		____name could be a list, containing [______string ____________vedfileprops _________subsystem]
		or consref({____name, ___________getbuffer_p})
	*/
define vedreadfile(name, defaults_p) -> (new, newfile);
	...
	if dev or getbuffer_p then
		...
		if getbuffer_p then
			;;; call user procedure with _________________setting_on_screen arg -- returns
...
enddefine;		/* TRANS_OUT */
	...
	/*	Write out a single line ______string
	*/
...
enddefine;		/* Trans_line_out */
	...
	/*	The basic write procedure -- takes an output file/device ____file
		and an optional arg _____plain (which defaults to vedwriteoutplain).

		_____plain has the following values
...
enddefine;
	...
	/*	____file is a file name or device.
		Write lines from __lo to __hi to the file.
	*/
...
define vars ved_w();
	if vedargument = nullstring then
		...
		;;; ______max(1, _______________vvedbuffersize) forces the file to be written even
		;;; if it's empty
...
--- John Gibson, Apr 27 1993
		Fixed treatment of ________defaults value in vedreadfile
