...
;;;	____Name				_________Subscript			____Glob_ ____Init (false if no decl/init)
;;;											____File_ ____Init
...
#_IF DEF WIN32
			...
			;;; 	____________veddirectory dir_>< __________vedcurrent -> ___________vedpathname
...
enddefine;
	...
	/*	Apply _p in environments corresponding to all the files in
...
#_IF DEF WIN32
				...
				;;; choose ______conv_p to try and minimise the number of
...
enddefine;
	...
	/*	Apply a procedure _p to make changes to a file ____file without forcing
...
define ved_file_change_apply(p, file);
	...
	define lconstant local_setonscreen(p);
		...
		define updaterof Onscreen_barrier(wason, nxtfile, context);
			...
			;;; shuffle ____file down to before _______nxtfile or to the end
			fast_lmember(file, vedbufferlist) -> l;
			until (fast_back(l) ->> m) == []
...
--- John Gibson, Apr 18 1996
		Made Set_variables remove any leading _____Class. from the vedfileprops
...
--- John Gibson, Nov 28 1995
		# Changed is_vedfile_local so that ____file arg can be omitted to default
		  to ved_current_file.
