...
;;; Pop variant that allows a conversion procedure _____acc_p to extract the call
;;; data from the exptr passed by XptCallbackWrapper (______conv_p may also be false)
